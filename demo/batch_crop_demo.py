#!/usr/bin/env python3
"""
Batch Crop Demo Script for Myotube Test Images (Instance Only)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Batch crop demo for myotube segmentation (instance only)")
